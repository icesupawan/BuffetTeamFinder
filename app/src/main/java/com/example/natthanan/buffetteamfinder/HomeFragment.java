...
//        args.putString(ARG_PARAM2, param2);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        // Tab
        final TabLayout tabLayout = (TabLayout) rootView.findViewById(R.id.home_tab_layout);
        final TabLayout.Tab listTab = tabLayout.newTab();
        ...
        listTab.setIcon(R.drawable.list_tab_white);
        mapTab.setIcon(R.drawable.map_tab);
...
//                Change Icon
                switch (position) {
                    ...
                    case 1: {
                        listTab.setIcon(R.drawable.list_tab);
                        mapTab.setIcon(R.drawable.map_tab_white);
                        break;
                    }
                }
//
